-- CUBRID DB Schema Backup: 20260225
-- Schema + Indexes
...
ALTER VCLASS [dba].[comvnusermaster] ADD QUERY ((select [dba.COMTNGNRLMBER].[ESNTL_ID], [dba.COMTNGNRLMBER].[MBER_ID], [dba.COMTNGNRLMBER].[PASSWORD],  cast( cast([dba.COMTNGNRLMBER].[MBER_NM] as varchar(60)) as varchar(60)), [dba.COMTNGNRLMBER].[ZIP], [dba.COMTNGNRLMBER].[ADRES], [dba.COMTNGNRLMBER].[MBER_EMAIL_ADRES], _utf8' ' collate utf8_bin,  cast(_utf8'GNR' collate utf8_bin as varchar(3)), _utf8' ' collate utf8_bin from [dba.COMTNGNRLMBER] [dba.COMTNGNRLMBER] union all select [dba.COMTNEMPLYRINFO].[ESNTL_ID], [dba.COMTNEMPLYRINFO].[EMPLYR_ID], [dba.COMTNEMPLYRINFO].[PASSWORD], [dba.COMTNEMPLYRINFO].[USER_NM], [dba.COMTNEMPLYRINFO].[ZIP], [dba.COMTNEMPLYRINFO].[HOUSE_ADRES], [dba.COMTNEMPLYRINFO].[EMAIL_ADRES],  cast( cast([dba.COMTNEMPLYRINFO].[GROUP_ID] as varchar) as varchar),  cast(_utf8'USR' collate utf8_bin as varchar(3)),  cast( cast([dba.COMTNEMPLYRINFO].[ORGNZT_ID] as varchar) as varchar) from [dba.COMTNEMPLYRINFO] [dba.COMTNEMPLYRINFO]) union all select [dba.COMTNENTRPRSMBER].[ESNTL_ID], [dba.COMTNENTRPRSMBER].[ENTRPRS_MBER_ID], [dba.COMTNENTRPRSMBER].[ENTRPRS_MBER_PASSWORD], [dba.COMTNENTRPRSMBER].[CMPNY_NM], [dba.COMTNENTRPRSMBER].[ZIP], [dba.COMTNENTRPRSMBER].[ADRES], [dba.COMTNENTRPRSMBER].[APPLCNT_EMAIL_ADRES], _utf8' ' collate utf8_bin,  cast(_utf8'ENT' collate utf8_bin as varchar(3)), _utf8' ' collate utf8_bin from [dba.COMTNENTRPRSMBER] [dba.COMTNENTRPRSMBER]) order by 1 ;
