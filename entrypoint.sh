...
nohup java -jar /app/EurekaServer.jar > /app/eureka.log 2>&1 &
...
nohup java -jar /app/ConfigServer.jar > /app/config.log 2>&1 &
...
nohup java -jar /app/GatewayServer.jar > /app/gateway.log 2>&1 &
