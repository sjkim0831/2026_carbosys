...
@Controller("uiaEgovAdminLoginManageAPIController")
@RequestMapping("/admin/login")
@RequiredArgsConstructor
@Slf4j
public class EgovAdminLoginManageAPIController {
    ...
    private final EgovAdminLoginManageService service;
    ...
    public ResponseEntity<?> actionLogin(@RequestBody LoginVO loginVO, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (ObjectUtils.isEmpty(loginDTO)) {
            ...
            log.debug("EgovAdminLoginManageAPIController actionLogin isAuthenticated >>> {}", EgovUserDetailsHelper.isAuthenticated());
            ...
            log.debug("EgovAdminLoginManageAPIController actionLogin accessiblePatterns >>> {}", accessiblePatterns);
    ...
    public ResponseEntity<?> actionLogout(HttpServletRequest request, HttpServletResponse response) {
        log.debug("##### EgovAdminLoginManageAPIController logout started #####");
