...
public class CpmClient {
	...
	public void start() {
		...
		egovframework.com.mip.mva.sp.websocket.client.cpm.CpmClientMsgHandler socket = new egovframework.com.mip.mva.sp.websocket.client.cpm.CpmClientMsgHandler(wsInfo);
