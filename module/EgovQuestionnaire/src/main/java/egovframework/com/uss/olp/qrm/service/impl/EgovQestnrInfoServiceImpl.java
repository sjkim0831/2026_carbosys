...
import egovframework.com.uss.olp.qrm.entity.QQestnrInfo;
import egovframework.com.uss.olp.qrm.entity.QUserMaster;
import egovframework.com.uss.olp.qrm.entity.QestnrInfo;
import egovframework.com.uss.olp.qrm.entity.UserMaster;
...
public class EgovQestnrInfoServiceImpl extends EgovAbstractServiceImpl implements EgovQestnrInfoService {
    ...
    public Page<QestnrInfoDTO> list(QestnrInfoVO qestnrInfoVO) {
        ...
        List<Tuple> query = queryFactory.select(qestnrInfo,userMaster)
                .from(qestnrInfo)
                .leftJoin(userMaster)
