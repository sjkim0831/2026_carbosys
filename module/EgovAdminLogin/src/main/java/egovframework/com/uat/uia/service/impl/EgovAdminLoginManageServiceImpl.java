...
import egovframework.com.uat.uia.repository.EgovAdminLoginPolicyRepository;
...
@Slf4j
public class EgovAdminLoginManageServiceImpl extends EgovAbstractServiceImpl implements EgovAdminLoginManageService {
	...
	private final EgovAdminLoginPolicyRepository loginPolicyRepository; // 로그인정책관리
    ...
    private String encryptPassword(String key, String salt) {
        try {
            ...
            log.debug("##### EgovAdminLoginManageServiceImpl NoSuchAlgorithmException >>> {}", e.getMessage());
            return "0";
        }
    }
